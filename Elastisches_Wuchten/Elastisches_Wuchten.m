...
antwort = ["Die Auswuchtsetzung beträgt", gewicht_1, " gramm.", "Der Winkel unter dem die Auswuchtsetzung angebracht werden muss beträgt: ", winkel_1];
disp(antwort);
%% plot Polar 
fig8 = figure(8);

compassplot([0 accel_1_0_angle/180*pi], [0 accel_1_0_amp], "black-o", "DisplayName", "r_0");
legend show

%% Zweite Eigenform berechnen

% Datensatz zerlegen
data1_2 = null_lauf_mode_2(:,1);
data2_2 = null_lauf_mode_2(:,2);
tr_2 = null_lauf_mode_2(:,3);
t_2 = linspace(0, length(data1_0)/f_s_0, length(data1_0));

%% Zuschnitt
[accel_1_cut_2, accel_2_cut_2, trigger_cut_2, t_cut_2] = ...
    cut_signals(null_lauf_mode_2(:,1), null_lauf_mode_2(:,2), null_lauf_mode_2(:,3), t_2); % Null-Lauf geschnitten

%% Plotting raw data
plot_raw_data(null_lauf_mode_2, t_2, "(0-Lauf)");

%% Plotting cut data
plot_cut_data(accel_1_cut_2, accel_2_cut_2, trigger_cut_2, t_cut_2, "(0-Lauf) geschnitten");
...
% Den Index auf die Beschleunigungen im Frequenzbereich anwenden und dort
% die Werte auslesen
[trigger_2_fft, trigger_cut_2_index] = trigger_data(trigger_cut_2);
[accel_1_2_fft, accel_1_2_amp, accel_1_2_angle] = create_fft(accel_1_cut_2, trigger_cut_2_index);
[accel_2_2_fft, accel_2_2_amp, accel_2_2_angle] = create_fft(accel_2_cut_2, trigger_cut_2_index);

%% FFT plotting
[accel_1_2_fft_plot] = plot_fft(accel_1_2_fft, f_s_0, "Beschleunigung 1 (0-Lauf)");
[accel_2_2_fft_plot] = plot_fft(accel_2_2_fft, f_s_0, "Beschleunigung 2 (0-Lauf)");
[trigger_2_fft_plot] = plot_fft(trigger_2_fft, f_s_0, "Triggerfunktion (0-Lauf)");

%% 3D Plot der Fourier Signale
% tiled(trigger_fft_plot, accel_1_0_fft_plot, accel_2_0_fft_plot, "0-Lauf");
%% Komplexe Zahlen bilden

accel_1_2 = accel_1_2_amp + 1i*accel_1_2_angle;
accel_2_2 = accel_2_2_amp + 1i*accel_2_2_angle;
%% Polar coordinate plot
plot_polarcoordinates(accel_1_2_amp, accel_1_2_angle, accel_2_2_amp, accel_2_2_angle);

%% Zweite Eigenform eins_lauf
